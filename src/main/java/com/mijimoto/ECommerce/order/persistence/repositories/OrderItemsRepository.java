...
import com.mijimoto.ECommerce.order.persistence.entities.OrderItems;

/**
 * Spring Data JPA repository for entity "OrderItems" <br>
 *
...
public interface OrderItemsRepository extends JpaRepository<OrderItems, Long> {
    ...
    // List<OrderItems> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<OrderItems> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<OrderItems> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<OrderItems> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
