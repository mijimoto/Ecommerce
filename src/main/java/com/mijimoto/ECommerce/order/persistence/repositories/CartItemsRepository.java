...
import com.mijimoto.ECommerce.order.persistence.entities.CartItems;

/**
 * Spring Data JPA repository for entity "CartItems" <br>
 *
...
public interface CartItemsRepository extends JpaRepository<CartItems, Integer> {
    ...
    // List<CartItems> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<CartItems> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<CartItems> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<CartItems> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
