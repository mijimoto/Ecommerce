...
import com.mijimoto.ECommerce.order.persistence.entities.ShoppingCarts;

/**
 * Spring Data JPA repository for entity "ShoppingCarts" <br>
 *
...
public interface ShoppingCartsRepository extends JpaRepository<ShoppingCarts, Integer> {
    ...
    // List<ShoppingCarts> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<ShoppingCarts> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<ShoppingCarts> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<ShoppingCarts> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
