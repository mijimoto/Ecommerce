...
import com.mijimoto.ECommerce.catalogue.persistence.entities.Attributes;

/**
 * Spring Data JPA repository for entity "Attributes" <br>
 *
...
public interface AttributesRepository extends JpaRepository<Attributes, Integer> {
    ...
    // List<Attributes> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Attributes> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Attributes> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Attributes> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
