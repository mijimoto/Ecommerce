...
/**
 * Spring Data JPA repository for entity "ProductVariants" <br>
 *
...
public interface ProductVariantsRepository extends JpaRepository<ProductVariants, Integer> {
    ...
    // List<ProductVariants> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<ProductVariants> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<ProductVariants> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<ProductVariants> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
