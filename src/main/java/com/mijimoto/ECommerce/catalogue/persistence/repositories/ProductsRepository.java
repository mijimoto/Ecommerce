...
/**
 * Spring Data JPA repository for entity "Products" <br>
 *
...
public interface ProductsRepository extends JpaRepository<Products, Integer> {
    ...
    // List<Products> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Products> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Products> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Products> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
