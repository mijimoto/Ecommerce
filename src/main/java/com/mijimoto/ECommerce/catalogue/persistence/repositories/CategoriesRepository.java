...
import com.mijimoto.ECommerce.catalogue.persistence.entities.Categories;

/**
 * Spring Data JPA repository for entity "Categories" <br>
 *
...
public interface CategoriesRepository extends JpaRepository<Categories, Integer> {
    ...
    // List<Categories> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Categories> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Categories> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Categories> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
