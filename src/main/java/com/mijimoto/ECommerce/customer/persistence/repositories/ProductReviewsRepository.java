 ...
 */
package com.mijimoto.ECommerce.customer.persistence.repositories;

import org.springframework.data.jpa.repository.JpaRepository;

import com.mijimoto.ECommerce.customer.persistence.entities.ProductReviews;

/**
 * Spring Data JPA repository for entity "ProductReviews" <br>
 *
...
public interface ProductReviewsRepository extends JpaRepository<ProductReviews, Long> {
    ...
    // List<ProductReviews> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<ProductReviews> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<ProductReviews> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<ProductReviews> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
