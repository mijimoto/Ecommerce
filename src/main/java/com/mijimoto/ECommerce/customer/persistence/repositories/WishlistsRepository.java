...
import com.mijimoto.ECommerce.customer.persistence.entities.Wishlists;

/**
 * Spring Data JPA repository for entity "Wishlists" <br>
 *
...
public interface WishlistsRepository extends JpaRepository<Wishlists, Integer> {
    ...
    // List<Wishlists> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Wishlists> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Wishlists> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Wishlists> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
