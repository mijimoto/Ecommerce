...
import com.mijimoto.ECommerce.persistence.entities.UserPhoneNumbers;

/**
 * Spring Data JPA repository for entity "UserPhoneNumbers" <br>
 *
 ...
 * @author Telosys
 */
public interface UserPhoneNumbersRepository extends JpaRepository<UserPhoneNumbers, Integer> {

    // -- Add your custom finder methods below --

    // Example: Find by a String field
    // List<UserPhoneNumbers> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<UserPhoneNumbers> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<UserPhoneNumbers> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<UserPhoneNumbers> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
