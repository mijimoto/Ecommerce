...
import com.mijimoto.ECommerce.persistence.entities.Addresses;

/**
 * Spring Data JPA repository for entity "Addresses" <br>
 *
...
public interface AddressesRepository extends JpaRepository<Addresses, Integer> {
    ...
    // List<Addresses> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Addresses> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Addresses> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Addresses> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
