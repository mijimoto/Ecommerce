...
/**
 * Spring Data JPA repository for entity "Roles" <br>
 *
...
public interface RolesRepository extends JpaRepository<Roles, Integer> {
    ...
    // List<Roles> findByXxx(String xxx);

    // Example: Find by a field with LIKE behavior
    // List<Roles> findByXxxContaining(String xxx);

    // Example: Find by a numerical field
    // List<Roles> findByYyy(BigDecimal yyy);

    // Example: Find by foreign key (like PartID)
    // List<Roles> findByPartID(Integer partID); // Use Optional<> or single result for OneToOne
